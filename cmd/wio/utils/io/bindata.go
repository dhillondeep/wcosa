...
func assetsCliHelperAppHelpTxt() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/cli-helper/app-help.txt", size: 1189, mode: os.FileMode(436), modTime: time.Unix(1529620085, 0)}
...
func assetsConfigurationsStructureAvrJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/configurations/structure-avr.json", size: 4063, mode: os.FileMode(436), modTime: time.Unix(1529620085, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func assetsTemplatesReadmePkg_readmeMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/templates/readme/PKG_README.md", size: 160, mode: os.FileMode(436), modTime: time.Unix(1529620085, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
