...
if (WIN32)
  if (DEFINED ENV{ARDUINO_SDK_PATH})
      string(REPLACE "\\" "/" AVR_PATH $ENV{ARDUINO_SDK_PATH})
      set(AVR_PATH "${AVR_PATH}/hardware/tools/avr")
  else()
      message(FATAL_ERROR "Define ARDUINO_SDK_PATH as a system variable")
  endif()
endif()
...
if (WIN32)
      # window paths
      set(AVR_CC_PATH "${AVR_PATH}/bin/avr-gcc.exe")
      set(AVR_CXX_PATH "${AVR_PATH}/bin/avr-g++.exe")
      set(AVR_OBJCOPY_PATH "${AVR_PATH}/bin/avr-objcopy.exe")
      set(AVR_SIZE_TOOL_PATH "${AVR_PATH}/bin/avr-size.exe")
      set(AVR_OBJDUMP_PATH "${AVR_PATH}/bin/avr-objdump.exe")
else()
      # linux/unix paths
      find_program(AVR_CC_PATH avr-gcc)
      find_program(AVR_CXX_PATH avr-g++)
      find_program(AVR_OBJCOPY_PATH avr-objcopy)
      find_program(AVR_SIZE_TOOL_PATH avr-size)
      find_program(AVR_OBJDUMP_PATH avr-objdump)
endif()

set(AVR_CC ${AVR_CC_PATH})
set(AVR_CXX ${AVR_CXX_PATH})
set(AVR_OBJCOPY ${AVR_OBJCOPY_PATH})
set(AVR_SIZE_TOOL ${AVR_SIZE_TOOL_PATH})
set(AVR_OBJDUMP ${AVR_OBJDUMP_PATH})
