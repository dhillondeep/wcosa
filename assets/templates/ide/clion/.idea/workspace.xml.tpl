...
<project version="4">
    ...
    <component name="CMakeSettings" AUTO_RELOAD="true">
        <configurations>
            <configuration PROFILE_NAME="Debug" CONFIG_NAME="Debug" GENERATION_DIR=".wio/ide/clion/{{TARGET_NAME}}" />
        </configurations>
    </component>
    <component name="ChangeListManager">
        <list default="true" id="ec922180-b3d3-40f1-af0b-2568113a9075" name="Default" comment="" />
        <ignored path="wio.yml" />
    ...
    <component name="FileEditorManager">
        <leaf>
            <file leaf-file-name="wio.yml" pinned="false" current-in-tab="true">
                <entry file="file://$PROJECT_DIR$/wio.yml"/>
            </file>
        </leaf>
    </component>
    ...
    <component name="PropertiesComponent">
        ...
        <property name="last_opened_file_path" value="$PROJECT_DIR$/wio.yml" />
    ...
    <component name="RunManager" selected="Application.WIO_BUILD">
        ...
        <configuration default="false" name="WIO_CLEAN" type="CMakeRunConfiguration" factoryName="Application" WORKING_DIR="" PASS_PARENT_ENVS="FALSE" PROJECT_NAME="{{PROJECT_NAME}}" TARGET_NAME="WIO_CLEAN" CONFIG_NAME="Debug">
            <envs />
            <method />
        </configuration>
        <configuration default="false" name="WIO_CLEAN_HARD" type="CMakeRunConfiguration" factoryName="Application" WORKING_DIR="" PASS_PARENT_ENVS="FALSE" PROJECT_NAME="{{PROJECT_NAME}}" TARGET_NAME="WIO_CLEAN_HARD" CONFIG_NAME="Debug">
            <envs />
            <method />
        </configuration>
        ...
        <configuration default="false" name="WIO_UPDATE" type="CMakeRunConfiguration" factoryName="Application" WORKING_DIR="" PASS_PARENT_ENVS="FALSE" PROJECT_NAME="{{PROJECT_NAME}}" TARGET_NAME="WIO_UPDATE" CONFIG_NAME="Debug">
            <envs />
            <method />
        </configuration>
        <list size="8">
